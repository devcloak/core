...
echo 'alias xinren="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/devcloak/core.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/devcloak/core.git'"
...
rm -rf "$HOME/.config/@xinren"
rm -rf "$HOME/.config/@xinren"
rm -rf "$HOME/.config/xinren-core"
